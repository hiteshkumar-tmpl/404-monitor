      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Receive 404 alerts directly in your Microsoft Teams channel. Follow
          ...
          <div className="border rounded-lg p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Enter a name for the webhook (e.g., "404 Monitor Alerts"). You
        ...
        <div className="border rounded-lg p-6 border-amber-500/40 bg-amber-500/5">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            ...
            be the <strong>same JSON object</strong> 404 Monitor POSTs: the root must
        ...
        <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Create a dedicated channel for 404 alerts (e.g., "Website
