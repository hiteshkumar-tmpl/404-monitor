...
export default function Dashboard() {
  ...
  const websitesList: Website[] = Array.isArray(websites)
    ? websites
    : Array.isArray((websites as unknown as { data?: unknown })?.data)
      ? (websites as unknown as { data: Website[] }).data
      : [];
    ...
    <div className="space-y-8">
          ...
          <CardContent>
            {loadingSummary ? (
              ...
              <div
                ...
                data-testid="stat-total-websites"
              >
                {summary?.totalWebsites || 0}
              </div>
            )}
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            {loadingSummary ? (
              ...
              <div className="text-2xl font-bold" data-testid="stat-total-urls">
                {summary?.totalUrls || 0}
              </div>
            )}
          </CardContent>
          ...
          <CardContent>
            {loadingSummary ? (
              ...
              <div
                ...
                data-testid="stat-total-broken"
              >
                {summary?.totalBroken || 0}
              </div>
            )}
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            {loadingSummary ? (
              ...
              <div
                className="text-2xl font-bold text-destructive"
                data-testid="stat-sites-errors"
              >
                {summary?.websitesWithErrors || 0}
              </div>
            )}
          </CardContent>
        </Card>
      ...
      <div className="space-y-4">
        ...
        <TrendChart
          ...
          title="Broken URLs Over Time"
          description="Total broken URLs across all monitored websites"
        />
      </div>
      ...
      <div className="space-y-4">
        ...
        {loadingWebsites ? (
          ...
          <div className="grid gap-3">
            {websitesList.map((website: Website) => (
              <Card
                key={website.id}
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            <AlertDialogTitle>
                              Remove monitoring for {website.name}?
                            </AlertDialogTitle>
                            <AlertDialogDescription>
                              This action cannot be undone. All historical data
                              and monitored URLs for this property will be
                              permanently deleted.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
